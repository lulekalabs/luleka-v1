...
namespace :db do
  namespace :mysql do
    ...
    task :backup => :environment do
      ...
      archive = "#{RAILS_ROOT}/backup/backup_#{current_date}.sql"
  ...
  desc 'Create YAML test fixtures from data in an existing database. ' +
    ...
    'SET FIXTURES to determine which tables to extract, e.g. FIXTURES=table1,table2'
  task :extract_fixtures => :environment do
    ...
    tables.each do |table_name|
      i = "000"
      File.open("#{RAILS_ROOT}/db/yml/#{table_name}.yml", 'w') do |file|
