...
module LocalizedCountrySelect
  class << self
    ...
    def localized_countries_array
      I18n.translate(:countries).map {|key, value| [value, key.to_s.upcase]}.sort_by {|country| country.first.parameterize}
    end
    ...
    def priority_countries_array(country_codes=[])
      ...
      country_codes.blank? ? [] : country_codes.map { |code| [countries[code.to_s.upcase.to_sym], code.to_s.upcase] }
    end
  end
end
  ...
  module Helpers
    ...
    module FormOptionsHelper
      ...
      def localized_country_options_for_select(selected = nil, priority_countries = nil)
        ...
        return country_options + options_for_select(LocalizedCountrySelect::localized_countries_array - 
          LocalizedCountrySelect::priority_countries_array(priority_countries), selected)
      end
