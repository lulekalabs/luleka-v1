...
class Translation < ActiveRecord::Base
  ...
  named_scope :untranslated, :conditions => "translations.value IS NULL", :order => :raw_key
  named_scope :translated,   :conditions => "translations.value IS NOT NULL", :order => :raw_key
