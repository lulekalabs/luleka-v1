...
module SitemapGenerator
  module Helper
    ...
    def ping_search_engines(sitemap_index)
      ...
      {:google => "http://www.google.com/webmasters/tools/ping?sitemap=#{index_location}",
        :yahoo => "http://search.yahooapis.com/SiteExplorerService/V1/updateNotification?appid=YahooDemo&url=#{index_location}",
